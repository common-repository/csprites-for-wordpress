...
class Sprite{
  ...
  public static function styleSize($path){
    return ($node = SpriteStyleRegistry::getStyleNode($path))?($node->getSizeArray()):('');
  }
  ...
  public static function reset(){
    SpriteTemplateRegistry::reset();       
    SpriteImageRegistry::reset();
    SpriteStyleRegistry::reset();
    SpriteCache::reset();
  }
